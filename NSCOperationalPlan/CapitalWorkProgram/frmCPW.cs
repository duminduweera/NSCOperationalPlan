...
{
    public partial class frmCPW : Form
    {
        /* 
         * 
        */
        ...
        private void txtCPWBudget_Leave(object sender, EventArgs e)
        {
            double number;
            Double.TryParse(txtCPWBudget.Text, out number);

            txtCPWBudget.Text = string.Format("{0:0,0.00}", number);
            Double.TryParse(txtRevisedBudget.Text, out number);
            if (chk1.Checked && number == 0) { txtRevisedBudget.Text = txtCPWBudget.Text; }
        }
        private void txtProjectedBudget_Leave(object sender, EventArgs e)
        {
            double number;
            Double.TryParse(txtRevisedBudget.Text, out number);

            txtRevisedBudget.Text = string.Format("{0:0,0.00}", number);
        }
        private void txtCPWBudget_Enter(object sender, EventArgs e)
        {
            double number;
            Double.TryParse(txtCPWBudget.Text, out number);

            txtCPWBudget.Text = string.Format("{0:#.##}", number);
        }
        private void txtProjectedBudget_Enter(object sender, EventArgs e)
        {
            double number;
            Double.TryParse(txtRevisedBudget.Text, out number);

            txtRevisedBudget.Text = string.Format("{0:#.##}", number);
        }
        ...
        private void tsbEdit_Click(object sender, EventArgs e)
        {
            ...
            txtJobCostNumber.Enabled = false;
        }
